...
<html lang="en">
  <head>
    ...
    <title>Admin | Menaxho perdoruesit</title>
  ...
  <section id="container" >
      <header class="header black-bg">
            ...
            <a href="#" class="logo"><b>Paneli i adminit</a>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Menaxho perdoruesit</h3>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Te dhenat e perdoruesit </h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th>Nr.</th>
                                  <th class="hidden-phone">Emri</th>
                                  <th> Mbiemri</th>
                                  <th> Email adresa</th>
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td>
                                     ...
                                     <button class="btn btn-danger btn-xs" onClick="return confirm('A jeni i sigurt qe doni ta fshini?');"><i class="fa fa-trash-o "></i></button></a>
                                  </td>
                              </tr>
                              <?php $cnt=$cnt+1; }?>
